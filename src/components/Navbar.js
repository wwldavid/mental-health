...
const Navbar = ({ mobile = false }) => {
  ...
  if (mobile) {
    return (
      <div className="fixed bottom-0 left-0 w-full h-24 pb-6 z-[100] border-t-2 border-[#325C77]/50 shadow-md flex justify-around items-center min-h-[64px] md:hidden">
        <button
